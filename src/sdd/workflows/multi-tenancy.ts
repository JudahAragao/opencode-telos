...
export function createTenantChange(
  _graph: KnowledgeGraph,
  workflow: MultiTenancyWorkflow
): { change: ChangeNode; tenant: TenantNode } {
...
export function getTenantInstructions(tenant: TenantNode): string {
  const lines = [
