...
export function buildGraphFromAnalysis(graph, analysis) {
    ...
    progressEmitter.stepProgress("relationships", `Inference: ${inference.applied} edges applied, ${inference.normalized} normalized, ${inference.milestones_created} milestones`, undefined, buildId);
    ...
    progressEmitter.stepProgress("connectivity", `Integrity: ${integrityReport.summary.fixes_applied} fixes applied, ` +
        ...
        `${integrityReport.summary.disconnected_groups_found} disconnected groups`, undefined, buildId);
    ...
    // Complete build
    progressEmitter.complete(`Graph built: ${nodesCreated} nodes, ${totalRelationships} relationships, ${totalFixes} integrity fixes`, { nodesCreated, relationshipsCreated: totalRelationships, integrityReport, byType }, buildId);
    // Build summary
    const lines = [
