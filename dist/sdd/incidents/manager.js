export function createIncident(_graph, workflow) {
...
export function getIncidentInstructions(incident) {
    const lines = [
        '## Gestão de Incidente',
        '',
    ...
    lines.push('', '### Próximos Passos', '1. Identificar causa raiz', '2. Implementar correção', '3. Verificar resolução', '4. Documentar lições aprendidas');
    return lines.join('\n');
}
