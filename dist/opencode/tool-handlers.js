...
export async function savePermissionsConfigHandler(args, ctx) {
    try {
...
export async function listSnapshotsHandler(_args, ctx) {
...
export async function verifyUsageHandler(_args, ctx) {
...
export async function findDeadCodeHandler(args, ctx) {
...
export async function removeDeadCodeHandler(args, ctx) {
...
export async function planImplementationHandler(args, ctx) {
...
export async function analyzeCodebaseHandler(_args, ctx) {
    const repo = getRepo(ctx.directory);
    if (!repo.isInitialized())
        return "SDD not initialized.";
...
export async function createMigrationHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function createExperimentHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function createFlagHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function createTenantHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function generateDashboardHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function reportIncidentHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function createSlaHandler(args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function estimateCostHandler(_args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function knowledgeTransferHandler(_args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
...
export async function disasterRecoveryPlanHandler(_args, ctx) {
    const graph = loadOrEmpty(ctx.directory);
